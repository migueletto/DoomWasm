...
void D_DoomLoop (void)
{
    ...
    DG_debug(DEBUG_INFO, "I_SetWindowTitle");
    I_SetWindowTitle(gamedescription);
    I_GraphicsCheckCommandLine();
    I_SetGrabMouseCallback(D_GrabMouseCallback);
    //I_RegisterWindowIcon(doom_icon_data, doom_icon_w, doom_icon_h);
    DG_debug(DEBUG_INFO, "I_InitGraphics");
    I_InitGraphics();
    //EnableLoadingDisk();
    I_SetPalette(W_CacheLumpName("PLAYPAL", PU_CACHE));

    DG_debug(DEBUG_INFO, "TryRunTics");
    TryRunTics();
    DG_debug(DEBUG_INFO, "TryRunTics end");

    DG_debug(DEBUG_INFO, "V_RestoreBuffer");
    V_RestoreBuffer();
    R_ExecuteSetViewSize();

    DG_debug(DEBUG_INFO, "D_StartGameLoop");
    D_StartGameLoop();
