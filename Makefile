...
LINKFLAGS=--no-entry -s INITIAL_MEMORY=67108864 -s IMPORTED_MEMORY -s EXPORTED_FUNCTIONS=_DoomInit,_DoomStep,_DoomKey,_DoomName,_DoomWadName,_DoomWadAlloc -s ERROR_ON_UNDEFINED_SYMBOLS=0 -s SAFE_HEAP=1
